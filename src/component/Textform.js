    ...
    return (
        <>
            <div className='Container' style={{ color: props.mode === 'dark' ? 'white' : '#1a1d45' }}>
                ...
                <button type="button" className='btn btn-primary mx-1 btn-sm' onClick={hendleOnClick} >UPPERCASE</button>
                <button type="button" className='btn btn-primary mx-1 btn-sm' onClick={hendleLoClick} >lowercase</button>
                <button type="button" className='btn btn-primary mx-1 btn-sm' onClick={hendleSetCase} >Sentence Case</button>
                <button type="button" className='btn btn-primary mx-1 btn-sm' onClick={hendletrim} >Trim</button>
                <button type="button" className='btn btn-primary mx-1 btn-sm' onClick={hendleCopy} >Copy Text</button>
                <button type="button" className='btn btn-primary mx-1 btn-sm' onClick={hendleClear} >Clear</button>
            </div>
